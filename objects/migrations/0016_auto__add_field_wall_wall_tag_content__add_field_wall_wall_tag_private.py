...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Wall.wall_tag_content'
        db.add_column(u'objects_wall', 'wall_tag_content',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=300, blank=True),
                      keep_default=False)

        # Adding field 'Wall.wall_tag_private'
        db.add_column(u'objects_wall', 'wall_tag_private',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Wall.wall_tag_content'
        db.delete_column(u'objects_wall', 'wall_tag_content')

        # Deleting field 'Wall.wall_tag_private'
        db.delete_column(u'objects_wall', 'wall_tag_private')
    ...
    models = {
        ...
        u'objects.entry': {
            ...
            'author_pic_uri': ('django.db.models.fields.CharField', [], {'default': "'dummy_4'", 'max_length': '50'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'objects.wall': {
            ...
            'wall_tag_content': ('django.db.models.fields.CharField', [], {'max_length': '300', 'blank': 'True'}),
            'wall_tag_private': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
