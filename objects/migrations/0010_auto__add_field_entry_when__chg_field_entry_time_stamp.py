...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.when'
        db.add_column(u'objects_entry', 'when',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 4, 0, 0)),
                      keep_default=False)


        # Changing field 'Entry.time_stamp'
        db.alter_column(u'objects_entry', 'time_stamp', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):
        # Deleting field 'Entry.when'
        db.delete_column(u'objects_entry', 'when')


        # Changing field 'Entry.time_stamp'
        db.alter_column(u'objects_entry', 'time_stamp', self.gf('django.db.models.fields.DateTimeField')())
