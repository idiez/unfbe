...
urlpatterns = patterns('',
    ...
    url(r'^objects/wall/rate/$', views.ratewall_view, name='ratewall_view'),
    url(r'^objects/wall/updateprivacy/$', views.wallupdateprivacy_view, name='wallupdateprivacy_view'),
   	url(r'^objects/wall/(?P<wall_req>.+)/(?P<user_req>.+)/$', views.getwall_view, name='getwall_view'),
    url(r'^objects/entry/delete/$', views.deleteentry_view, name='deleteentry_view'),
